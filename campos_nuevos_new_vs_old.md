...
Comparaci?n por rutas de propiedades JSON Schema. Los arreglos se indican con `[]`.

## Resumen

| Schema | Archivo new | Archivo old | Campos nuevos |
|---|---|---|---:|
| `fe-eges` | `svfe-json-schemas-new\v1\fe-eges-v1.json` | `sin equivalente` | 74 |
| `fe-eop` | `svfe-json-schemas-new\v1\fe-eop-v1.json` | `sin equivalente` | 43 |
| `fe-eret` | `svfe-json-schemas-new\v1\fe-eret-v1.json` | `sin equivalente` | 91 |
| `fe-cd` | `svfe-json-schemas-new\v2\fe-cd-v2.json` | `svfe-json-schemas-old\fe-cd-v1.json` | 34 |
| `fe-cl` | `svfe-json-schemas-new\v2\fe-cl-v2.json` | `svfe-json-schemas-old\fe-cl-v1.json` | 10 |
| `fe-cr` | `svfe-json-schemas-new\v2\fe-cr-v2.json` | `svfe-json-schemas-old\fe-cr-v1.json` | 10 |
| `fe-dcl` | `svfe-json-schemas-new\v2\fe-dcl-v2.json` | `svfe-json-schemas-old\fe-dcl-v1.json` | 3 |
| `fe-f` | `svfe-json-schemas-new\v2\fe-f-v2.json` | `svfe-json-schemas-old\fe-fc-v1.json` | 5 |
| `fe-fse` | `svfe-json-schemas-new\v2\fe-fse-v2.json` | `svfe-json-schemas-old\fe-fse-v1.json` | 14 |
| `fe-fex` | `svfe-json-schemas-new\v3\fe-fex-v3.json` | `svfe-json-schemas-old\fe-fex-v1.json` | 22 |
| `invalidacion-schema` | `svfe-json-schemas-new\v3\invalidacion-schema-v3.json` | `svfe-json-schemas-old\anulacion-schema-v2.json` | 3 |
| `contingencia-schema` | `svfe-json-schemas-new\v4\contingencia-schema-v4.json` | `svfe-json-schemas-old\contingencia-schema-v3.json` | 1 |
| `fe-ccf` | `svfe-json-schemas-new\v4\fe-ccf-v4.json` | `svfe-json-schemas-old\fe-ccf-v3.json` | 6 |
| `fe-nc` | `svfe-json-schemas-new\v4\fe-nc-v4.json` | `svfe-json-schemas-old\fe-nc-v3.json` | 17 |
| `fe-nd` | `svfe-json-schemas-new\v4\fe-nd-v4.json` | `svfe-json-schemas-old\fe-nd-v3.json` | 22 |
| `fe-nr` | `svfe-json-schemas-new\v4\fe-nr-v4.json` | `svfe-json-schemas-old\fe-nr-v3.json` | 4 |
